...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_without_id_raises(self):
        ...
        with self.assertRaises(Exception) as context:
            product.update()
        self.assertIn("empty ID", str(context.exception))
    ...
    def test_deserialize_type_error(self):
        """It should raise DataValidationError when deserializing non-dict"""
        product = Product()
        with self.assertRaises(Exception) as context:
    ...
    def test_deserialize_missing_key(self):
        ...
        data = {
            ...
            "price": "10.00",
            "available": True,
            "category": "FOOD",  # missing 'description'
        }
        product = Product()
        with self.assertRaises(Exception) as context:
            product.deserialize(data)
    ...
    def test_find_by_price_as_string(self):
        ...
        for p_var in found:
            self.assertEqual(p_var.price, Decimal("19.99"))
